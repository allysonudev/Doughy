...
struct ParsedIngredient: Sendable {
    ...
    @Guide(description: """
        ...
        cucharada/cucharadas -> tablespoon, cucharadita/cucharaditas -> teaspoon; French tasse -> cup, cuillère à soupe -> \
        tablespoon, cuillère à café -> teaspoon; German Tasse -> cup, Esslöffel -> \
        tablespoon, Teelöffel -> teaspoon; Italian tazza -> cup, cucchiaio -> tablespoon, \
        cucchiaino -> teaspoon; Portuguese xícara/chávena -> cup, colher de sopa -> \
        tablespoon, colher de chá -> teaspoon; Icelandic bolli -> cup, matskeið -> \
        tablespoon, teskeið/teskeiðar -> teaspoon; Japanese カップ -> cup, 大さじ/大匙 -> \
        tablespoon, 小さじ/小匙 -> teaspoon; Korean 컵 -> cup, 큰술 -> tablespoon, \
        작은술 -> teaspoon.
        """)
